                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-12 col-md-5 col-lg-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="form-floating flex-grow-1">
                                                ...
                                                <label for="proveedor">RTN Proveedor</label>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3">
                                        <div class="form-floating mb-2">
                                            ...
                                            <div class="invalid-feedback"> Tipo de Comprobante</div>
                                        </div>
                                    </div>
                        ...
                        <table id="tbl_productos" class="table table-striped w-100 shadow border border-secondary">
                            <thead class="bg-main">
                                <tr style="font-size: 15px;">
                                    ...
                                    <th>Categoría</th> <!-- 5 -->
                                    <th>Producto</th> <!-- 6 -->
                                    <th>Id Tipo Afec. ISV</th> <!-- 7 -->
                                    <th>Tipo Afec. ISV</th> <!-- 8 -->
                                    <th>Id Unidad Medida</th> <!-- 9 -->
                                    <th>Unidad Medida</th> <!-- 10 -->
                                    <th>Costo Unit.</th> <!-- 11 -->
                                    <th>Precio C/ISV</th> <!-- 12 -->
                                    <th>Precio S/ISV</th> <!-- 13 -->
                                    <th>Precio Mayor C/ISV</th> <!-- 14 -->
                                    <th>Precio Mayor S/ISV</th> <!-- 15 -->
                                    <th>Precio Oferta C/ISV</th> <!-- 16 -->
                                    <th>Precio Oferta S/ISV</th> <!-- 17 -->
                                    <th>Stock</th> <!-- 18 -->
                                    <th>Min. Stock</th> <!-- 19 -->
                                    <th>Ventas</th> <!-- 20 -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-floating mb-2">
                                        ...
                                        <label for="precio_unitario_oferta_con_igv">Precio Oferta (con ISV)</label>
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-floating mb-2">
                                        ...
                                        <label for="precio_unitario_oferta_sin_igv">Precio Oferta (sin ISV)</label>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-12 col-md-5 col-lg-3 mb-1">
                        <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-id-card mr-1 my-text-color"></i> RTN</label>
...
<script>
        ...
        $("#serie").keypress(function(e) {
            ...
            if ($("#tipo_comprobante").val()) {
                if ($("#serie").val().length < 1) {
                    ...
                    if ($("#tipo_comprobante").val() == "02") {
                        if (key != 99 && key != 67) {
                            mensajeToast("warning", "La seria de la Cotizacion debe empezar con la letra C")
                            $("#serie").val('')
                            e.preventDefault();
                        }
                    }
    ...
    function fnc_GuardarCompra() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $ope_gravadas = $("#resumen_opes_gravadas").html().replace('L/ ', '').trim();
                $ope_exoneradas = $("#resumen_opes_exoneradas").html().replace('L/ ', '').trim();
                $ope_inafectas = $("#resumen_opes_inafectas").html().replace('L/ ', '').trim();
                $total_igv = $("#resumen_total_igv").html().replace('L/ ', '').trim();
                $total_descuento = $("#resumen_total_descuento").html().replace('L/ ', '').trim();
                $total = $("#resumen_total_venta").html().replace('L/ ', '').trim();
    ...
    *=========================================================================================================================================*/
    function fnc_LimpiarFomulario() {
        ...
        //Datos del Resumen
        $("#resumen_opes_gravadas").html('L/ 0.00')
        $("#resumen_opes_inafectas").html('L/ 0.00')
        $("#resumen_opes_exoneradas").html('L/ 0.00')
        $("#resumen_subtotal").html('L/ 0.00')
        $("#resumen_total_igv").html('L/ 0.00')
        $("#resumen_total_venta").html('L/ 0.00')
    ...
    *=========================================================================================================================================*/
    ...
    function fnc_ImprimirCompra(data) {
        ...
        window.open('http://localhost/market-pos-v38/vistas/generar_registro_compra.php?id_compra=' + $id_compra,
            'fullscreen=yes' +
            "resizable=0,"
        );
    }
