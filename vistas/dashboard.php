                     ...
                     <div class="card-body">
                         ...
                         <div class="chart">
                             ...
                             <div id="chartContainer"
                                 style="min-height: 250px; height: 300px; max-height: 350px; width: 100%;"></div>
...
function cargarGraficoBarras() {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            $("#title-header-ventas-mes").html('VENTAS DEL MES: S./ ' + total_ventas_mes.toFixed(2)
            ...
            var areaChartData = {
                ...
                datasets: [{
                    ...
                    label: 'Ventas del Mes - ' + +Number(mes_actual.getMonth() + 1) + '/' +
                ...
                animation: {
                    ...
                    onComplete: function() {
                        ...
                        for (var i = 0; i < this.data.datasets[1].data.length; i++) {
                            ...
                            var model = this.data.datasets[1]._meta[Object.keys(this.data.datasets[
                                    1]._meta)[0]].data[i]._model,
                                scale_max = this.data.datasets[1]._meta[Object.keys(this.data
                                    .datasets[1]._meta)[0]].data[i]._yScale.maxHeight;
