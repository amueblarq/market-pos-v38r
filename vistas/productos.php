...
.mi-modal {
     ...
     position: fixed;
     /* Permite que el modal flote sobre el contenido */
     z-index: 1;
     /* Coloca el modal por encima del resto del contenido */
     left: 0;
     top: 0;
     width: 100%;
     height: 100%;
     overflow: auto;
     /* Habilita el desplazamiento si el contenido es demasiado grande */
 ...
 .boton-notificacion {
   ...
   display: inline-block; /* Hacemos que sea un elemento de bloque en línea */
...
<body>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h2 class="m-0 fw-bold">INVENTARIO / MATERIA PRIMA</h2>
    
 <!-- Boton de abrir notificaciones y envio de materiales  -->

 <div class="container">
        <h2></h2>
        <!-- Botón para abrir el nuevo modal -->
        <button onclick="mostrarNuevoModal()" class="boton-notificacion">Abrir Notificaciones</button>
    ...
    <!-- Botón pedido de materiales -->
    <a href="http://localhost/market-pos-v38/pedidos_materialesb.php" class="envio-btn">Pedido de Materiales</a>

    <!-- Botón envío de materiales -->
    <a href="http://localhost/market-pos-v38/materiales_guardadosb.php" class="btn-material">Inventario de Materiales</a>   
   </div>
     <!-- Cierre del codigo donde estan los botones  -->
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Inventario / Materia Prima</li>
                </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="row">
                                ...
                                <div class="d-none d-md-flex col-md-12 ">
                                    ...
                                    <div style="width: 20%;" class="form-floating mx-1">
                                        ...
                                        <label for="iptCodigoBarras">Código de Producto</label>
                                    </div>

                                    <div style="width: 20%;" class="form-floating mx-1">
                                        <select class="form-select select2" id="id_categoria_busqueda" data-index="3"
                    ...
                    <table id="tbl_productos" class="table w-100 shadow border border-secondary">
                        <thead class="bg-main">
                            <tr style="font-size: 15px;">
                                ...
                                <th>Precio C/ISV</th> <!-- 12 -->
                                <th>Precio S/ISV</th> <!-- 13 -->
                                <th></th>
                                <!--14 -->
                                <th></th>
                                <!--15 -->
                                <th>Precio Oferta C/ISV</th>
                                <!--16 -->
                                <th>Precio Oferta S/ISV</th>
                                <!--17 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="form-floating mb-2">
                                    ...
                                    <label for="codigo_producto">Código de Productos</label>
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="form-floating mb-2">
                                    ...
                                    <select class="form-select select2" id="id_tipo_afectacion_igv"
                                        name="id_tipo_afectacion_igv" aria-label="Floating label select example"
                                        required>
                                    </select>
                                    <!--<label for="id_tipo_afectacion_igv">Tipo Impuesto</label>-->

                                    <div class="invalid-feedback">Seleccione el Tipo de Impuesto</div>
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <div class="form-floating mb-2">
                                    ...
                                    <label for="id_unidad_medida"> </label>
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="row">
                                    ...
                                    <!-- PRECIO DE VENTA (INC. ISV) -->
                                    <div class="col-12 col-lg-6">

                                        <div class="form-floating mb-2">

                                            <input type="number" min="0" class="form-control form-control-sm"
                                                id="precio_unitario_con_igv" name="precio_unitario_con_igv" step="0.01"
                                                required>
                                            <label for="precio_unitario_con_igv">Precio (con ISV)</label>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-floating mb-2">
                                            ...
                                            <input type="number" min="0" value="0" class="form-control form-control-sm"
                                                id="precio_unitario_sin_igv" name="precio_unitario_sin_igv" step="0.01"
                                                readonly>
                                            <label for="precio_unitario_sin_igv">Precio (sin ISV)</label>
                                        </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-floating mb-2">
                                        ...
                                        <label for="precio_unitario_mayor_con_igv">Precio x Mayor (con ISV)</label>
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-floating mb-2">
                                        ...
                                        <label for="precio_unitario_mayor_sin_igv">Precio x Mayor (sin ISV)</label>

                                    </div>-->


                                    <!-- PRECIO VENTA EN OFERTA (INC. ISV) -->
                                    <div class="col-12 col-lg-6">

                                        <div class="form-floating mb-2">

                                            <input type="number" min="0" class="form-control form-control-sm"
                                                id="precio_unitario_oferta_con_isv"
                                                name="precio_unitario_oferta_con_isv" step="0.01">
                                            <label for="precio_unitario_oferta_con_isv">Precio Oferta (con ISV)</label>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-floating mb-2">
                                            ...
                                            <input type="number" min="0" class="form-control form-control-sm"
                                                id="precio_unitario_oferta_sin_isv"
                                                name="precio_unitario_oferta_sin_isv" value="0" step="0.01" readonly>
                                            <label for="precio_unitario_oferta_sin_isv">Precio Oferta (sin ISV)</label>
                                    ...
                                    <div class="col-12 col-lg-12">
                                        <div class="form-floating mb-2">
                                            <input type="number" min="0" class="form-control form-control-sm"
                                                id="minimo_stock" name="minimo_stock">
                            ...
                            <a style="width:170px;" class="btn btn-outline-success mt-1 mx-1" id="btnGuardarProducto">Guardar Producto</a> -->
                                ...
                                <a class="btn btn-danger  fw-bold " id="btnCancelarRegistro"
...
===============================================================================================================================-->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-secondary btn-sm" data-bs-dismiss="modal"
                        id="btnCancelarRegistroStock">Cancelar</a>
    ...
    $(document).ready(function() {
        ...
        $("#precio_unitario_con_isv").on("keyup", function() {

            if ($("#impuesto").val() == '') {
                mensajeToast('warning', 'Seleccione el Tipo de Impuesto')
                $("#precio_unitario_con_isv").val('')
                return;
            }

            precio_unitario_con_isv = parseFloat($("#precio_unitario_con_isv").val());
            precio_unitario_sin_isv = parseFloat(precio_unitario_con_isv / (1 + ($("#impuesto_producto").val() / 100))).toFixed(2);
            $("#precio_unitario_sin_isv").val(precio_unitario_sin_isv)
        });

        $("#precio_unitario_mayor_con_isv").on("keyup", function() {
            ...
            precio_unitario_mayor_con_isv = parseFloat($("#precio_unitario_mayor_con_isv").val());
            precio_unitario_mayor_sin_isv = parseFloat(precio_unitario_mayor_con_isv / (1 + ($("#impuesto_producto").val() / 100))).toFixed(2);
            $("#precio_unitario_mayor_sin_isv").val(precio_unitario_mayor_sin_isv)
        });

        $("#precio_unitario_oferta_con_isv").on("keyup", function() {
            ...
            precio_unitario_oferta_con_isv = parseFloat($("#precio_unitario_oferta_con_isv").val());
            precio_unitario_oferta_sin_isv = parseFloat(precio_unitario_oferta_con_isv / (1 + ($("#impuesto_producto").val() / 100))).toFixed(2);
            $("#precio_unitario_oferta_sin_isv").val(precio_unitario_oferta_sin_isv)
        });

        $('#id_tipo_afectacion_isv').on('select2:select', function(e) {
            ...
            formData.append('id_tipo_afectacion', $('#id_tipo_afectacion_isv').val());
            ...
            if (response) {
                ...
                precio_unitario_sin_isv = parseFloat($("#precio_unitario_con_isv").val() / (1 + ($("#impuesto_producto").val() / 100))).toFixed(2);
                $("#precio_unitario_sin_isv").val(precio_unitario_sin_isv);


                precio_unitario_mayor_sin_isv = parseFloat($("#precio_unitario_mayor_con_isv").val() / (1 + ($("#impuesto_producto").val() / 100))).toFixed(2);
                $("#precio_unitario_mayor_sin_isv").val(precio_unitario_mayor_sin_isv);

                precio_unitario_oferta_sin_isv = parseFloat($("#precio_unitario_oferta_con_isv").val() / (1 + ($("#impuesto_producto").val() / 100))).toFixed(2);
                $("#precio_unitario_oferta_sin_isv").val(precio_unitario_oferta_sin_isv);
            }

            // $("#precio_unitario_con_isv").val('');
            // $("#precio_unitario_mayor_con_isv").val('');
            // $("#precio_unitario_oferta_con_isv").val('');
            // $("#precio_unitario_sin_igv").val('');
            // $("#precio_unitario_mayor_sin_isv").val('');
            // $("#precio_unitario_oferta_sin_isv").val('');
    ...
    function fnc_ModalActualizarProducto(fila_actualizar) {
        ...
        $("#id_tipo_afectacion_isv").val(data['id_tipo_afectacion_isv']).change();
        console.log($('#id_tipo_afectacion_isv').val());
        ...
        $("#precio_unitario_con_isv").val(data['precio_unitario_con_isv']);
        $("#precio_unitario_sin_isv").val(data['precio_unitario_sin_isv']);
        $("#precio_unitario_mayor_con_isv").val(data['precio_unitario_mayor_con_isv']);
        $("#precio_unitario_mayor_sin_isv").val(data['precio_unitario_mayor_sin_isv']);
        $("#precio_unitario_oferta_con_isv").val(data['precio_unitario_oferta_con_isv']);
        $("#precio_unitario_oferta_sin_isv").val(data['precio_unitario_oferta_sin_isv']);
    ...
    function fnc_cargarSelectCategorias() {
        CargarSelect(null, $("#id_categoria_busqueda"), "Categorías", "ajax/categorias.ajax.php", 'obtener_categorias', null, 1);
        CargarSelect(null, $("#id_categoria"), "Seleccione una categoría", "ajax/categorias.ajax.php", 'obtener_categorias');
        CargarSelect(null, $("#id_tipo_afectacion_isv"), "Seleccione Tipo de impuesto ISV", "ajax/productos.ajax.php", 'listar_tipo_afectacion');
        CargarSelect(null, $("#id_unidad_medida"), "Unidad/Medida", "ajax/productos.ajax.php", 'listar_unidad_medida');
        $('.select2').select2()
    }
